...
That endgame's unwind failure - `used 0%` frame after frame with a window to spend and the residual climbing 5 to 20 mm a frame, on a coil of 44 nodes carrying more arc than the chain has length - is a standing weakness the latch papers over, and is recorded here rather than fixed.
