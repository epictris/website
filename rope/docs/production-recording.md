...
Beside the runs, the store keeps **feedback**: five stars and a comment, left at the bell that ends a level or from the level select's `rate` link (see [**Levels**](levels.md#the-feedback-form)).
