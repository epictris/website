"""Render a contact sheet and close-up of the v3 vine variants."""
...
import procedural_vines_v3 as procedural_vines
...
scene.render.filepath = str(Path(__file__).resolve().parent / "vine_output_v3" / "vine_preview.png")
...
scene.render.filepath = str(Path(__file__).resolve().parent / "vine_output_v3" / "vine_detail.png")
bpy.ops.render.render(write_still=True)
