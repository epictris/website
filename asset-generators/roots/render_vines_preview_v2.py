"""Render a contact sheet and close-up of the v2 vine variants."""
...
import procedural_vines_v2 as procedural_vines
...
scene.render.filepath = str(Path(__file__).resolve().parent / "vine_output_v2" / "vine_preview.png")
...
scene.render.filepath = str(Path(__file__).resolve().parent / "vine_output_v2" / "vine_detail.png")
bpy.ops.render.render(write_still=True)
